...
\usepackage{url}
\usepackage{booktabs}
\title{Sensor Failure Compositionality: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robust multimodal robot learning. The original research bet was: Study when failures of sensors compose predictably versus catastrophically. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Red-Teaming Vision-Language-Action Models via Quality Diversity Prompt Generation for Robust Robot Policies (2026)
\item When Vision Overrides Language: Evaluating and Mitigating Counterfactual Failures in VLAs (2026)
\item Development of compositionality through interactive learning of language and action of robots (2025)
\item PolyTouch: A Robust Multi-Modal Tactile Sensor for Contact-rich Manipulation Using Tactile-Diffusion Policies (2025)
\item REFLEX Dataset: A Multimodal Dataset of Human Reactions to Robot Failures and Explanations (2025)
\end{itemize}
